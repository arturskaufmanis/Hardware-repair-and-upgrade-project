...
|----------|-------------|
| `IMG20260312120343.jpg` | Device bottom cover — pre-disassembly |
| `IMG20260312121105.jpg` | Bottom panel removed — initial internal view |
| `IMG20260312121244.jpg` | Internal layout with battery and motherboard visible |
| `IMG20260312121611.jpg` | RAM slot — single 8 GB module confirmed |
| `IMG20260312125330.jpg` | Full disassembly — all components laid out in sequence |
| `IMG20260312131329.jpg` | Keyboard and palmrest separated from chassis |
| `IMG20260312131703.jpg` | Motherboard removed and isolated |
| `IMG20260312132032.jpg` | Components organised for controlled reassembly |
| `IMG20260312133930.jpg` | Heat gun (DeWalt) used to soften keyboard rivet adhesive |
| `IMG20260312134508.jpg` | Palmrest detail — damaged keyboard removed |
| `IMG20260312134543.jpg` | Motherboard close-up — component identification |
| `IMG20260312135838.jpg` | Reassembly in progress |
| `IMG20260312144157.jpg` | Replacement keyboard fitted to palmrest |
| `IMG20260312144424.jpg` | Battery reinstalled; RAM upgrade module staged |
| `IMG20260312153919.jpg` | New 8 GB SODIMM ready for installation |
| `IMG20260312163055.jpg` | Both RAM slots occupied |
| `IMG20260312173507.jpg` | Laptop fully reassembled — rear view |
| `IMG20260312174121.jpg` | First power-on — Windows 11 OOBE |
| `IMG_20260312_174209.jpg` | OOBE with external keyboard connected during initial setup |
| `IMG20260312190822.jpg` | System > About — 16 GB RAM and Ryzen 5 PRO 4650U confirmed |
